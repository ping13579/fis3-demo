...
(function($, window, undefined) {
    ...
    Dialog.prototype = {
        ...
        ok : function() {
            ...
            }).addClass(okClass).prependTo(footer).tap(function(){
        ...
        cancel : function() {
            ...
            var a_cancel = '<a class = "cancel_class">'+this.settings.cancelText+'</a>'
            // $('<a>', {
            //     href : 'javascript:;',
            ...
            footer.prepend(a_cancel);
            $(".cancel_class").addClass(canncelClass).tap(function(){
                var cancelCallback = _this.settings.cancel;
                if (cancelCallback == undefined || !cancelCallback) {
                    _this.close();
                }else{
        ...
        size : function() {
            ...
            wrap.width(this.settings.width);
        ...
        position : function() {
            ...
            this.dialog.css({
                ...
                top : (winHeight - _this.dialog.height()) / 2.4 + scrollTop
            });
